...
#       2026-07 같은 동반 급락에서 낙폭이 컸다. 백테스트상 5종이 CAGR을
#       거의 그대로 두면서(28.87%→28.94%) MDD를 -15.59%→-12.34%,
#       Sharpe를 1.59→1.66으로 개선한다. 6·7종으로 더 늘리면 MDD는 계속
#       줄지만 CAGR이 꺾인다(6종 25.76%). '종목을 늘리면 낙폭이 준다'는
#       방향은 견고하나, 하필 5종이 최적이라는 건 표본상의 우연일 수 있다.
