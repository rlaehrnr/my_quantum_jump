    ...
    if st.session_state.get('custom_run_us', False):
        with st.spinner("미국 커스텀 시뮬레이션 중..."):
            ...
            if not df_res_c.empty:
                ...
                with col_bc: 
                    st.download_button("📥 종합 엑셀 리포트 다운로드", data=excel_data_t4, file_name="US_커스텀_백테스트.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", use_container_width=True)
