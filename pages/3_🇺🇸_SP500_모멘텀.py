...
# 네이버 증권 예외 규칙 사전 정의 (.O 기본, 지정 종목은 .K)
...
# ==========================================
with tab1:
    # 💡 1. 소수점(2026.0) 에러 방지: 미리 정수로 깔끔하게 만든 years_list를 재활용합니다.
    ...
    # 💡 2. 안전장치 추가: 혹시라도 소수점이 들어와도 무조건 깔끔한 정수로 변환하여 에러 원천 차단
